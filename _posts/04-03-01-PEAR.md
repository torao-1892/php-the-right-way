...
Você pode instalar o PEAR baixando o instalador phar e executando-o. A documentação do PEAR tem [instuções de instalação
mais detalhada][2] para todos sistemas operacionais.

Se você usa Linux, pode conferir no seu gerenciador de pacotes da sua distribuição. Debian e Ubuntu, por exemplo, tem um
pacote `php-pear`.
...
Quando este código é instalado ficará disponível dentro do seu diretório vendor e disponível automaticamente através do
