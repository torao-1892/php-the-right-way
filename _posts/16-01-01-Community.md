...
Outros recursos da comunidade incluem o Google+ PHP [Programmer community][php-programmers-gplus] e o [StackOverflow][php-so].
...
[Meetup.com][meetup] ou [PHP.ug][php-ug]. Se você vive em uma cidade menor, talvez não exista um PUG local; se for o caso, comece um!
